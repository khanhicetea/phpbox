...
# Pick Singapore mirror for fast and reliable packages.
apt-mirror-pick "$MIRROR_COUNTRY_CODE"
...
# Install PHP
if [ "$PHP_VERSION" -eq 5 ]; then
  apt-packages-install apache2 libapache2-mod-php5 php5 php5-cli \
    php5-common php5-xdebug php5-json \
